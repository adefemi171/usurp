  ...
  return (
    <main className="wrap auth-layout">
      <div className="auth-story">
        ...
        <p>
          A home for your AI coding activity. See what you use, find your
          people, and build your own momentum.
        </p>
        <ul>
          <li>Your conversations stay on your device</li>
          <li>You choose where you compete</li>
          <li>One view across your coding tools</li>
        </ul>
      </div>
      <div>
        {params.deleted === "1" && (
          <p className="notice ok" role="status">
            Your account and stored usage have been deleted. You are signed out.
          </p>
        )}
        ...
        <section className="signin-card" aria-label="Sign in options">
          ...
          <p className="auth-note">
            Signing in never joins a public board automatically. You decide what
            to share in Settings.
          </p>
          {emailAuthEnabled() ? (
            ...
            <p className="field-hint">
              Email sign-in will be available once this deployment’s email
              sender is configured.
            </p>
          )}
          <p className="field-hint">
            Already use GitHub? Continue with GitHub, then link your email in
            Settings to keep one account.
          </p>
        </section>
